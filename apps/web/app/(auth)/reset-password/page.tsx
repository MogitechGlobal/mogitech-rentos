...
// We extract the actual form into its own component so we can wrap it in Suspense
  ...
  if (status === 'success') {
    return (
      <div className="text-center animate-in zoom-in-95 duration-500">
        ...
        <Link 
          href="/login" 
          className="inline-flex w-full items-center justify-center gap-2 rounded-xl bg-[#1f8898] hover:bg-[#0f4952] px-4 py-3.5 text-sm font-bold text-white shadow-sm hover:shadow-md transition-all"
        >
