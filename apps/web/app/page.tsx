...
async function getFeaturedListings() {
  ...
  // SMART FALLBACK: Real, Newest Properties sourced directly from your active database.
  return [
    {
...
export default async function HomePage() {
  ...
  return (
    <div className="flex min-h-screen flex-col bg-[#f6f8f9] font-sans selection:bg-[#1f8898]/30">
      ...
      {/* 
        Moved Structured Data inside the main wrapper to fix React Hydration Mismatch.
        Browsers won't re-order these out of the layout flow this way.
      */}
